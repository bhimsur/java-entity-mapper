...
public class DepositAccount {
    ...
    public DepositAccount(String productType, String productCode, String accountNumber, Date createdDate, BigDecimal balanceAvailable, BigDecimal balanceHold, int term, String termCode, double interestRate) {
